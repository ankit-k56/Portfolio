...
const ProjectCard: React.FC<Project> = ({
  ...
  return (
    <div className="w-full">
      <div className="flex max-w-[1300px] mx-auto flex-col-reverse  border-[1px] bg-zinc-950 rounded-xl sm:flex-row  p-8 md:p-12 lg:p-20 gap-4 sm:gap-8">
        <div className="flex justify-between flex-col">
          <div>
            <h1 className="text-2xl md:text-3xl py-2 text-emerald-500">
              {title}
            </h1>
        ...
        <Image
          width={400}
          height={140}
          className="w-full sm:w-[85%] md:h-[300px] object-cover "
          src={image}
          alt="pic"
        />
      </div>
