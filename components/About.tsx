...
const About = () => {
  ...
  return (
    <div
      id="about"
      className="flex flex-col md:flex-row px-10 xl:px-36 lg:px-28 pt-10 items-center xl:py-36 pb-28 bg-black"
    >
      <Image
        ref={scope}
        className="rounded-full  mx-8 w-[45%] sm:py-0 py-3 sm:w-[35%] xl:w-[40%] md:w-[25%]  object-cover items-center"
        src={"/Ank.JPG"}
        alt="me"
        width={280}
        height={660}
